namespace a{
    public partial class aa : System.Windows.Forms.Form{
        ...
        internal void a1(int x, int y, bool aaaa){ 
            ...
            for (int i = 1; i < 24 * 24; i++) a1a.SetPixel(i / 24, i % 24, aa1);
            a11[x, y].Image = a1a;}
